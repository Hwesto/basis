...
> **⚠ Canonical source moved.** Per-decision markdown now lives under [`docs/schema/decisions/`](docs/schema/decisions/) and per-question markdown under [`docs/schema/open_questions/`](docs/schema/open_questions/). See [`docs/schema/README.md`](docs/schema/README.md) for the status table. This monolith is kept for reference and may be regenerated from the split files. Do not edit this file directly.
